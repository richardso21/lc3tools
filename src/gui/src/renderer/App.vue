          ...
          <v-card>
            <v-container>
              ...
              <v-layout row>
                ...
                <v-flex shrink>
                  <v-radio-group
                    @change="saveSettings('editorBinding')"
              ...
              <v-layout row>
                ...
                <v-flex shrink>
                  <v-switch
                    @change="saveSettings('runUntilHalt')"
              ...
              <v-layout row>
                <v-flex grow
                  ><h3>Clear Output on Object File Reload</h3></v-flex
                >
                <v-flex shrink>
                  <v-switch
                    @change="saveSettings('clearOutOnReload')"
              ...
              <v-layout row>
                ...
                <v-flex shrink>
                  <v-switch
                    @change="saveSettings('liberal-asm')"
      ...
      <v-dialog v-model="update_dialog" max-width="400" persistent>
        <v-card>
          ...
          <v-card-actions v-if="!download_bar">
            <v-spacer></v-spacer>
            <v-tooltip top>
              <v-btn icon flat @click="ignoreUpdate" slot="activator">
