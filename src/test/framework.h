...
/*
 * This file is an unpleasant artifact of breaking backward compatibility with
 * framework1.
 *
 * The purpose is to act as a wrapper around the names in framework1,
 * framework2, and framework2110 so that, to the unit test, using framework2 is
 * as simple as adding a single #define FRAMEWORK2, and anything without that
 * define will default to framework1.
 */
...
int main(int argc, char *argv[]) {
  ...
  std::cout << "*                                                              "
               "                *\n";
  std::cout << "* Version 1 of the API is deprecated and no longer supported.  "
               "Please use the  *\n";
  std::cout << "* guide at the following URL to update this unit test:         "
               "                *\n";
  std::cout << "*   "
               "https://github.com/chiragsakhuja/lc3tools/blob/master/docs/"
               "UPGRADE1.md     *\n";
  std::cout << "*                                                              "
               "                *\n";
  std::cout << "***************************************************************"
