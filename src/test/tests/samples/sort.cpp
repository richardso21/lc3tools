...
void verify(bool success, lc3::sim& sim, std::vector<int16_t> const& data,
            std::string const& label, double points, Tester& tester) {
  if (!success) {
    tester.error(label, "Execution hit exception");
    return;
  }
...
void ExampleTest(lc3::sim& sim, Tester& tester, double total_points) {
  std::vector<int16_t> data = {
      static_cast<int16_t>(0xFFFF), static_cast<int16_t>(0x0062),
      static_cast<int16_t>(0x0A73), static_cast<int16_t>(0x006C),
      static_cast<int16_t>(0x0070), static_cast<int16_t>(0x0001),
      static_cast<int16_t>(0x0063), static_cast<int16_t>(0x0065),
      static_cast<int16_t>(0x0062), static_cast<int16_t>(0x0073),
      static_cast<int16_t>(0x006E), static_cast<int16_t>(0x006B),
      static_cast<int16_t>(0xFF76), static_cast<int16_t>(0x0F7A),
      static_cast<int16_t>(0x0068), static_cast<int16_t>(0x006D)};
...
void PositiveTest(lc3::sim& sim, Tester& tester, double total_points) {
  std::vector<int16_t> data = {0x0010, 0x000F, 0x000E, 0x000D, 0x000C, 0x000B,
...
void NegativeTest(lc3::sim& sim, Tester& tester, double total_points) {
  std::vector<int16_t> data = {
      static_cast<int16_t>(0xFFFF), static_cast<int16_t>(0xFFFE),
      static_cast<int16_t>(0xFFFD), static_cast<int16_t>(0xFFFC),
      static_cast<int16_t>(0xFFFB), static_cast<int16_t>(0xFFFA),
      static_cast<int16_t>(0xFFF9), static_cast<int16_t>(0xFFF8),
      static_cast<int16_t>(0xFFF7), static_cast<int16_t>(0xFFF6),
      static_cast<int16_t>(0xFFF5), static_cast<int16_t>(0xFFF4),
      static_cast<int16_t>(0xFFF3), static_cast<int16_t>(0xFFF2),
      static_cast<int16_t>(0xFFF1), static_cast<int16_t>(0xFFF0)};
...
void NoChangeTest(lc3::sim& sim, Tester& tester, double total_points) {
  std::vector<int16_t> data = {
      static_cast<int16_t>(0xFFF8), static_cast<int16_t>(0xFFF9),
      static_cast<int16_t>(0xFFFA), static_cast<int16_t>(0xFFFB),
      static_cast<int16_t>(0xFFFC), static_cast<int16_t>(0xFFFD),
      static_cast<int16_t>(0xFFFE), static_cast<int16_t>(0xFFFF),
      static_cast<int16_t>(0x0000), static_cast<int16_t>(0x0001),
      static_cast<int16_t>(0x0002), static_cast<int16_t>(0x0003),
      static_cast<int16_t>(0x0004), static_cast<int16_t>(0x0005),
      static_cast<int16_t>(0x0006), static_cast<int16_t>(0x0007)};

  setupMem(sim, data);

  bool success = sim.runUntilHalt();

  verify(success, sim, data, "Did not change already-sorted list", total_points,
         tester);
}
...
void OverflowTest(lc3::sim& sim, Tester& tester, double total_points) {
  ...
  verify(success, sim, data, "Sorted overflowing numbers", total_points,
         tester);
}
